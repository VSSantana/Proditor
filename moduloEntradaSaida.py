...
class LeitorArquvo:
    ...
    def leitura_arquivo_processos(self, arquivo_processo):
        """
            Cria a lista de processos a partir do arquivo processo
            e retorna a lista criada
        """
        pid = 0
        lista_processos = []
    ...
    def leitura_arquivo_file(self, arquivo_file):
        """
            Cria a lista de arquivos e de instruções a partir do arquivo file
            e retorna as duas listas criadas
        """
        lista_arquivos = []
...
class Impressao:
    ...
    def __init__(self):
        """
            Construtor da classe de Impressao
        """
        self.log_operacao = []

    def imprimir_mapa_disco(self, mapa_disco):
        """
            Método para imprime o mapa do disco
    ...
    def imprimir_dispatcher(self, processo):
        """
            Método para imprime a mensagem do dispatcher do processo referenciado
        """
        print('\ndispatcher =>')
    ...
    def imprimir_log(self):
        """
            Método para imprime o log das operacoes executadas
        """
